  ...
  return (
    <View style={styles.tabsContainer}>
      <TouchableOpacity
        style={[
          styles.tab,
          selectedTab === AnimStatus.AIRING && styles.selectedTab,
        ]}
      ...
      <TouchableOpacity
        style={[
          styles.tab,
          selectedTab === AnimStatus.COMPLETE && styles.selectedTab,
        ]}
      ...
      <TouchableOpacity
        style={[
          styles.tab,
          selectedTab === AnimStatus.UPCOMING && styles.selectedTab,
        ]}
